...
class CycleDetectionUndirectedBFS {
    ...
    CycleDetectionUndirectedBFS(int v) {
        this.vertex = v;
    ...
    public static void main(String args[]) {        
        CycleDetectionUndirectedBFS c = new CycleDetectionUndirectedBFS(10);
            addEdge(0, 1);
            addEdge(0, 2);
            //  addEdge(1, 2);
            addEdge(2, 3);
            ...
            addEdge(8, 9);
            addEdge(9, 7);
        System.out.println("The given graph  is cyclic ?:" + isCycle(adjList, 10));
    }
}